...
const VENAD = {
  ...
  rooms: [
    { id: 'nadumuttom',  name: 'Nadumuttom Suite',  price: '₹4,500' },
    { id: 'backwater',   name: 'Backwater Villa',   price: '₹6,500' },
    { id: 'plantation',  name: 'Plantation Room',   price: '₹3,200' },
    { id: 'heritage',    name: 'Heritage Loft',     price: '₹5,000' },
  ],
};
